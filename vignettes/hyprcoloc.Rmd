...
At the end of this section we introduce a function "sensitivity.plot" which, on varying the input values for the regional and alignment thresholds as well as the prior probability of colocalization, returns a heat-map that helps us to visuale how stable the clusters of colocalized traits are to variations in the algorithms input parameters. We expect this function to be a part of standard analyses, helping us to pinpoint the best candidate clusters of colocalized traits for follow-up analyses.    
...
<<<<<<< HEAD
=======
##### Performing a sensitivity analysis: changing the evidential strength of colocalization - through the regional and alignment thresholds - as well as the prior probability of coloclization (i.e. "prior.2") 

As part of your colocalization analyses, you should consider assessing how sensitive the clusters of colocalized traits are to the choice of: (i) the algorithm thresholds, i.e. colocalization cut-off $=P^{\ast}_{R}*P^{\ast}_{A}$, and; (ii) the prior belief about traits sharing a causal variant. HyPrColoc allows you to do this through a single function "sensitivity.plot", by varying the choice of regional and alignment thresholds as well as the colocalization prior ("prior.2") across a range of values. We start with the algorithms default settings and then increase these so that identification of clusters of colocalized traits becomes more challenging (i.e. traits must have stronger evidence of colocalization in order to be detected).   
>>>>>>> 4d5ac0f67f613581907948c7beefa44b198619e4
