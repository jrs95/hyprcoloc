...
As a final point of note, the regional association statistic is computed from a much smaller number of causal configurations than a full colocalization assessment. This means that when we employ the Bayesian divisive clustering algorithm using only the regional statistic we can rapidly identify clusters of traits which shared genetic associations.  It is therefore quick to   
