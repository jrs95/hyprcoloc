...
<< Getting started: inputting data to a performing a multi-trait colocalization assessment
==
...
<< Analysis protocol: Overview and detailed discussion
==
...
<<< Analysis protocol: A one stop HyPrColoc sensitivity analysis
===
...
sensitivity.plot(betas, ses, trait.names = traits, snp.id=rsid, 
                 reg.thresh = c(0.6,0.7,0.8,0.9), align.thresh = c(0.6,0.7,0.8,0.9), prior.2 = c(0.98, 0.99, 0.995), equal.thresholds = FALSE);
